              ...
              <div className="panel-title">
                <div>
                  ...
                  <p style={{ margin: '8px 0 0 0', fontSize: '11px', color: '#666' }}>
                    Powered by Spatial Analysis ({d.clusters?.some(c => c.source === 'hdbscan') ? 'HDBSCAN Machine Learning' : 'Density Assessment'})
                  </p>
                </div>
                        ...
                        <tr key={x.village + x.disease + idx} style={{ background: '#fffbfa' }}>
                          <td>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                              <span className={`badge ${x.source === 'hdbscan' ? 'green' : 'amber'}`} style={{ fontSize: '10px', padding: '1px 6px' }}>
                                {x.source === 'hdbscan' ? 'HDBSCAN' : 'Fallback'}
                              </span>
                            </div>
                          </td>
                          <td>
...
function Clusters() {
  ...
  return (
    <Page title="Active Outbreak Cluster Warnings" subtitle="Early warning triggers generated by spatial-temporal disease density and HDBSCAN spatial analysis">
      <section className="panel">
        <Load error={e}>
          {d && d.length ? (
            <div className="table-wrap">
                ...
                <tbody>
                  {d.map((x, idx) => (
                    <tr key={x.village + x.disease + idx}>
                      ...
                      <td>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <span className={`badge ${x.source === 'hdbscan' ? 'green' : 'amber'}`}>
                            {x.source === 'hdbscan' ? 'HDBSCAN ML' : 'Density Fallback'}
                          </span>
                        </div>
                      </td>
                    </tr>
        ...
        >
          <Popup>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '12px' }}>
              <span className={`badge ${c.source === 'hdbscan' ? 'green' : 'amber'}`}>
                {c.source === 'hdbscan' ? 'HDBSCAN ML' : 'Density Fallback'}
              </span>
            </div>
          </Popup>
        </Circle>
