...
def train_image_model():
    ...
    torch.save(model.state_dict(), os.path.join(BASE_DIR, "model_registry/lumpy_cnn_v1.pth"))
    
    # Save the class names so the API knows what index 0 and 1 mean!
    joblib.dump(class_names, os.path.join(BASE_DIR, "model_registry/lumpy_class_names.joblib"))
    
    print("--- TRAINING COMPLETE ---")
    print("Image Model weights successfully saved to /model_registry/lumpy_cnn_v1.pth!")
